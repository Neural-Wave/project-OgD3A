...
def main():
    ...
    original_matrix = read_adjacency_matrix('misc/oli/adjacency_matrix.txt')
    
    # Write the integer version of the original matrix
    write_adjacency_matrix(original_matrix, 'misc/adjacency_matrix_int.txt')
    
    # Read the first fifteen rows from head15.txt
    head15 = read_adjacency_matrix('misc/head15.txt')
    ...
    write_adjacency_matrix(original_matrix, 'misc/djacency_matrix_modified.txt')
